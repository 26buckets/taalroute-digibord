(function(root){
 ...
 const catalog={
  ...
  engines:[
   ...
   {id:'CARDS',label:'Kaarten',description:'Trek opdrachten als kaarten uit dezelfde sessieselectie.',variants:[{id:'content-pb001',label:'Canonieke grammaticakaarten'}]}
  ]
 };
