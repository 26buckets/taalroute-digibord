...
| Controle | Resultaat |
|---|---|
| `npm test` | PASS; WZ-schema, tellingen, bron-/bundelpariteit, antwoordmodelconsistentie, alle 680 items selecteerbaar; bestaande bank- en appcontroles |
...
| `npm run smoke` | PASS; 163 geometriecontroles, drie werelden, fullscreen en nul browserfouten |
...
| `BUILD_SMOKE=1 npm run test:wz:browser` | PASS; alle negen doelen via de interface, alle 680 renders, zes vormen, open guard, gesloten antwoorden, hervatten/Terug, instellingen/pionbehoud, toetsenbord/tik en 1440/1024/390 pixels |
...
| `git diff --check` | PASS |
| Visuele controle | Desktop WZ-bouwkaart, smalle spreekkaart en compacte oorspronkelijke bouwkaart bekeken |
