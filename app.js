...
function bindCards(kind){
 ...
 if(kind==='c1-between-lines'){
  ...
  $$('[data-c1-choice]').forEach(button=>button.onclick=()=>{
   ...
   const content=$('.c1-content');content.scrollTop+=$('#c1Feedback').getBoundingClientRect().top-content.getBoundingClientRect().top;
  });
  return;
 }
 if(kind==='tongue'){
