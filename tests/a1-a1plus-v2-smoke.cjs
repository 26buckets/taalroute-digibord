...
(async()=>{
 ...
 try{
  ...
  const checks=[
   ['circle','mx-1-onderweg-04-circle','Vertel hoe je naar het station gaat'],
   ['square','mx-1-winkelen-06-square','Vraag welke kaas mild is'],
   ['triangle','mx-1-dagelijks-08-triangle','Het is vijf kilometer en droog. Kies: fiets of bus'],
   ['diamond','mx-1-in-de-les-10-diamond','Je kunt de volgende les niet komen. Meld dit']
  ];
  ...
  console.log('PASS A1-A1+ v2 browser smoke: Vertel, Vraag, Kies en Regel iets');
