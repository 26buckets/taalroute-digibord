...
(async()=>{
 ...
 try{
  ...
  await page.locator('#tongueLevel').selectOption('A1');assert.equal(await page.locator('.card-counter').innerText(),'1 van 120');await page.locator('#tongueLevel').selectOption('A2');assert.equal(await page.locator('.card-counter').innerText(),'1 van 180');await page.locator('#tongueLevel').selectOption('C2');
