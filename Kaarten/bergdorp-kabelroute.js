DigiBoardNewWorld.create({
  ...
  "label": "Bergdorp",
  "title": "Bergdorp · over het dal",
  "image": "bergdorp-kabelroute-speelroute",
  "paintedRoute": true,
  "masks": [
    {
      "id": "bloembak",
      "path": "M320 496 L334 486 L363 489 L377 505 L387 526 L399 530 L409 570 L394 604 L352 616 L324 597 L308 560Z",
      "area": [
        303,
        479,
        413,
  ...
  "passages": [
    {
      ...
      "kind": "cable",
      "icon": "cable-car",
      "description": "Tussen vak 14 en 15 stapt de pion in de kabelbaan. Hij reist zichtbaar mee over het dal en stapt bij het andere dorp uit. Dit kost één gewone stap."
    }
  ],
  "previews": [
    {
