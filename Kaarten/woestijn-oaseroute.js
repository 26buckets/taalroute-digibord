DigiBoardNewWorld.create({
  ...
  "label": "Woestijn",
  "title": "Woestijn · naar de oase",
  "image": "woestijn-oaseroute-speelroute",
  "paintedRoute": true,
  "masks": [
    {
      "id": "zandsteen-in",
      "path": "M511 127 L511 75 Q524 25 572 27 Q630 23 648 79 L646 133 L619 134 L619 88 Q606 55 578 54 Q548 53 539 86 L539 129Z",
      "area": [
        505,
        20,
        651,
    ...
    {
      "id": "zandsteen-uit",
      "path": "M635 180 L636 135 Q649 93 686 93 Q735 94 748 141 L745 188 L721 187 L721 145 Q713 120 690 119 Q669 121 663 148 L663 182Z",
      "area": [
        630,
        87,
        753,
  ...
  "passages": [
    {
      ...
      "kind": "tunnel",
      "icon": "move-down",
      "description": "Tussen vak 11 en 12 loopt de pion de doorgang in. Hij verdwijnt helemaal en komt aan de andere kant weer tevoorschijn. Dit kost één gewone stap."
    }
  ],
  "previews": [
    {
