DigiBoardNewWorld.create({
  ...
  "label": "Museum",
  "title": "Museum · door de zalen",
  "image": "museum-zalenroute-speelroute",
  "paintedRoute": true,
  "masks": [
    {
      "id": "vitrine",
      "path": "M313 309 L355 287 L381 295 L438 370 L442 405 L454 414 L453 450 L432 461 L315 372Z",
      "area": [
        306,
        282,
        460,
    ...
    {
      "id": "sculptuur",
      "path": "M1405 214 L1426 188 L1448 192 L1459 223 L1454 254 L1482 263 L1492 278 L1491 363 L1448 378 L1420 363 L1418 280 L1409 268Z",
      "area": [
        1400,
        185,
        1496,
  ...
  "previews": [
    {
      "id": "museumzalen",
      "label": "Langs de vitrines",
      "icon": "landmark",
      "from": 3,
      "to": 11,
      "description": "De pion loopt langs de vitrines en schilderijen naar de volgende zaal."
    }
  ],
  "waypoints": {},
  "content": {
    "schemaVersion": 1,
    "id": "museum-zalenroute-v1",
    "version": "1.0.0",
    "title": "Museum · door de zalen",
