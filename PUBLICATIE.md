...
`npm run test:release:browser` controleert de echte standaard, zonder archiefvlag: 4.061 beschikbare opdrachten, lege/verborgen oude ingangen, mixen, bewaren en hervatten van goedgekeurde lessen, en het behouden maar niet afspelen van een oude WZ-les. De bestaande suites blijven de bewaarde bronvoorraad en oude weergaven controleren. `npm run test:practice:browser` controleert bediening en vaste vormgeving; `tests/practice-advance-browser.cjs` gebruikt de echte vrijgegeven selectie.
